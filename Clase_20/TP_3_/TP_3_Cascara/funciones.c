...
void agregarPelicula(EMovie* movie)
{
    ...
    movie = newMovieParametros(titulo, duracion, genero, buffer, puntaje, link, estado);
...
EMovie* newMovieParametros(char titulo[], int duracion, char genero[], char descripcion[], int puntaje, char link[], int estado)
{
    EMovie* p;
